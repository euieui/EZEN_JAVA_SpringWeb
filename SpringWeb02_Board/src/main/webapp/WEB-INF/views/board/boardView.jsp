...
<div id="wrap" align="center">
			...
			<td width="300" align="center">	
				<c:choose>
					<c:when test="${empty board.imagename }">
						<img src="resources/upload/noname.jpg" style="width:250px;">
					</c:when>
					<c:otherwise>
						<img src="resources/upload/${board.imagename }" style="width:250px;">
					</c:otherwise>
				</c:choose>
			</td>
		</tr>
	...
	<input type="button" value="게시글 삭제" onClick="open_win('boardDelectForm?num=${board.num}','delete')">
</div><br>
